...
public class Menu extends JFrame {
    ...
    public Menu(Controlador controlador) {
        ...
        btnMiHorario.addActionListener(e -> controlador.abrirMiHorario(this));

        // BOTÓN OTROS HORARIOS
        ...
        btnOtrosHorarios.addActionListener(e -> controlador.abrirOtrosHorarios(this));
        ...
        btnAlumnos.addActionListener(e -> controlador.abrirAlumnos(this));
        ...
        btnPerfil.addActionListener(e -> controlador.abrirPerfil(this));
