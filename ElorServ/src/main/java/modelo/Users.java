...
public class Users implements java.io.Serializable {
	...
	private Set<Matriculaciones> matriculacioneses = new HashSet<Matriculaciones>();
	private Set<Reuniones> reunionesesForAlumnoId = new HashSet<Reuniones>();
	private Set<Horarios> horarioses = new HashSet<Horarios>();
	private Set<Reuniones> reunionesesForProfesorId = new HashSet<Reuniones>();
